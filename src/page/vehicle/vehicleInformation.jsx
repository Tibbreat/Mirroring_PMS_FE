                ...
                <Row gutter={[16, 16]}>
                    <Col xs={24} sm={16}>
                        <Descriptions title="Thông tin nhà cung cấp" bordered>
                            <Descriptions.Item label="Tên người đại diện" span={3}>{vehicle?.model}</Descriptions.Item>
                            <Descriptions.Item label="Tên nhà cung cấp" span={3}>{vehicle?.color}</Descriptions.Item>
